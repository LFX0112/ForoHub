...
(
    ...
    primary key (id),
    constraint fk_topic_author_id FOREIGN KEY (id_author) REFERENCES profiles(id) ON DELETE CASCADE,
...
(
    ...
    constraint fk_answers_author_id foreign key(id_author) references profiles(id) ON DELETE CASCADE ,
